...
VENTAS_COLUMN_FORMATS = {
    ...
    COLUMN_NAMES["cob_generico"]: ColumnFormat(number_format='#,##0', width=13, font_bold=True, fill_color="E8D5F5"),
    ...
    COLUMN_NAMES["cob_marca"]: ColumnFormat(number_format='#,##0', width=13, font_bold=True, fill_color="E8D5F5"),
