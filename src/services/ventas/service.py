...
VENTAS_COLUMN_FORMATS = {
    ...
    COLUMN_NAMES["monto_generico"]: ColumnFormat(number_format='$ #,##0', width=15, font_bold=True, header_fill_color="0055A4", hidden=True),
    COLUMN_NAMES["desc_generico"]: ColumnFormat(number_format='$ #,##0', width=15, font_bold=True, header_fill_color="0055A4", hidden=True),
    ...
    COLUMN_NAMES["monto_marca"]: ColumnFormat(number_format='$ #,##0', width=15, font_bold=True, header_fill_color="0055A4", hidden=True),
    COLUMN_NAMES["desc_marca"]: ColumnFormat(number_format='$ #,##0', width=15, font_bold=True, header_fill_color="0055A4", hidden=True),
